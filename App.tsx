...
const App: React.FC = () => {
  ...
  return (
    <div id="simulation-report" className="bg-slate-50 min-h-screen font-sans text-slate-800 selection:bg-brand-primary selection:text-white pb-24 lg:pb-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-4 xl:col-span-4 space-y-6 lg:sticky lg:top-24">
            <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 overflow-hidden border border-slate-100">
              ...
              {/* Botão Desktop */}
              <div className="hidden lg:block p-4 bg-slate-50 border-t border-slate-100">
                  <button
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t border-slate-200 p-4 lg:hidden z-40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
          <button
            onClick={handleCalculate}
